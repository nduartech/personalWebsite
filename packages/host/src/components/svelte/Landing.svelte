<script lang="ts">
    ...
    const navigateTo = (url: string, transition: string) => {
        ...
        if (transition === "hinge") {
            ...
            if (buttons && buttons.length > 0) {
                for (let i = 0; i < buttons.length; i++) {
                    window.mobileCheck? buttons[i].classList.add("animated","zoomOut") :buttons[i].classList.add("animated", i%2 === 0 ? "zoomOutLeft" :"zoomOutRight");
                }
            }
            let buttonsAlt = document.getElementsByClassName("altNavBtn");
            if (buttonsAlt && buttonsAlt.length > 0) {
                for (let i = 0; i < buttonsAlt.length; i++) {
                    window.mobileCheck? buttonsAlt[i].classList.add("animated","zoomOut") :buttonsAlt[i].classList.add("alt-animated", "zoomOutDown");
                }
            }
    ...
    <div
        ...
        <div class="flex flex-col justify-start md:mt-20 sm:portrait_h-screen sm:landscape_h-fit md:landscape_h-screen w-full items-center">
            <div class="w-full px-5 flex flex-row justify-center items-center md:pt-16">
                <div class="flex flex-col md:flex-col w-full justify-center items-center space-x-5 my-5 md:space-x-0 md:space-y-2 text-center mt-20 md:mt-0 z-20"
                     id="hello">
