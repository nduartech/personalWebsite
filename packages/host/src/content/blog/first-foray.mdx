...
** Edit as of 2024-08-04 23:00:00 EST - I've decided to make a few changes since writing this post. First, I switched from ESLint and Prettier to [Biome](https://biomejs.dev/). Also, I moved from using Yarn to [Bun](https://bun.sh/), an alternative runtime to Node.js for JS. Last, this is not a statically generated site anymore. Now published [here](https://nathanld.netlify.app/), the code for which can be found [here](https://github.com/nduartech/personalWebsite/tree/netlifyAndServerIslands), this site utilizes the newly released [Server Islands](https://astro.build/blog/future-of-astro-server-islands/) experimental feature and is hosted on Netlify instead of Github.
</div>
