...
<div class="reset-tw">
    ...
    Given my preference for Unix, I’m seizing this opportunity to revert to a dual-boot system. This isn’t the first time I’ve made such a change; I’ve done so on several occasions with less justification.
    ...
    As always, I began by installing Ubuntu in a new partition/dual-boot setup. Unfortunately, after a month, I found the latest LTS release still plagued by bugs, especially with Wayland and Nvidia graphics cards causing frequent crashes. Disheartened by these issues, I began exploring alternatives. 

    I considered trying Debian or Fedora, but felt Debian likely would contain the same issues as Ubuntu and no experience using Fedora as a daily driver. And then I remembered my positive experience with Arch, as well as how intimidating the setup was. One Google search later, and I happily stumbled upon EndeavourOS, all the goodness of Arch without the headache of getting up and running. Wonderful.
