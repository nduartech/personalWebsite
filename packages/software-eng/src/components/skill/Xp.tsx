        ...
        <div class="se-w-11/12 se-min-h-fit">
            ...
            <div class="se-w-full se-h-fit se-flex se-flex-row md:se-flex-col se-justify-center se-items-center md:se-items-end top se-space-x-10 se-min-h-fit">
              <a href="https://www.linkedin.com/in/nathanduarte" class="se-cursor-pointer">
                <div class="se-flex se-flex-row se-justify-center se-items-center">
                  <p class="se-hidden md:se-flex se-text-regal-blue-100 se-text-xs lg:se-text-sm se-font-medium">LinkedIn</p>
                  ...
                  <p class="se-flex md:se-hidden se-text-regal-blue-100 se-text-xs se-font-medium">LinkedIn</p>
                </div>
              </a>
              <div class="se-flex se-flex-row se-justify-center se-items-center se-cursor-pointer"
                ...
                <p class="se-text-regal-blue-100 se-text-xs lg:se-text-sm se-font-medium">Resume PDF</p>
          ...
          <Show when={page() !== 0}>
            <div
              ...
              <p class="se-text-regal-blue-100 se-text-sm se-font-medium se-text-center">Context: {pages[page()].context}</p>
              <div class="se-flex se-flex-row se-flex-wrap se-w-full se-h-full se-justify-center se-items-center se-mt-1 md:se-mt-2 lg:se-hidden lg:se-invisible">
                <p class="se-text-regal-blue-100 se-text-sm se-font-medium se-text-center se-inline-flex">Tags: </p>
      ...
      <div
        ...
        <div class="se-w-1/2 se-h-fit se-flex se-flex-row se-justify-center se-items-center se-space-x-10">
          <div class="se-flex se-flex-row se-justify-center se-items-center se-cursor-pointer"
            ...
            <p class={(page() > 0 ? "se-text-regal-blue-100" : "se-text-gray-700") + " se-text-xs se-font-medium"}>Back</p>
          </div>
          <div class="se-flex se-flex-row se-justify-center se-items-center se-cursor-pointer"
               onClick={() => getNextPage()}>
            <p class={(page() < pages.length - 1 ? "se-text-regal-blue-100" : "se-text-gray-700") + " se-text-xs se-font-medium"}>Next</p>
