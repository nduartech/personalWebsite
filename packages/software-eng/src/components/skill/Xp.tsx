...
import '../../index.css';
  ...
  const pages = [
    ...
    },
    {
      ...
      blob: "This website  <a class='text-regal-blue-300 underline' href='https://github.com/nduartech/monorepo-v1' target='_blank'>started off</a> as an exploration of micro-frontends and SPAs, using Astro and SolidJS. The inspiration for that initial version came from this <a class='text-regal-blue-300 underline' href='https://medium.com/@sergio.a.soria/setting-up-micro-frontends-with-astro-and-ecma-script-modules-137340d2c520' target='_blank'>excellent Medium post by Sergio A. Arevalo Soria.</a> However, I later decided to rewrite the entire site in the single-spa framework, the code for which can be found <a class='text-regal-blue-300 underline' href='https://github.com/nduartech/nduartech.github.io' target='_blank'>here on Github</a>. As part of this rewrite, I wrote <a class='text-regal-blue-300 underline' href='https://github.com/nduartech/single-spa-solid' target='_blank'>a utility to allow the use of single-spa with SolidJS microfrontends</a>. The host framework, including the Light/Dark mode toggle is SolidJS, the landing page is written with Svelte, and both this and the interests page is written with Solid as well.",
    },
    {
