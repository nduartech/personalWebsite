        ...
        <div
            ...
            <div
                ...
                <InterestPage title="Ballroom Dance"
                              ...
                              icon={() => <svg class="w-16 h-16" fill="transparent" version="1.1"
                                               id="Layer_1"
            ...
            <div
                ...
                <InterestPage title="Reading"
                              ...
                              icon={() => <svg width="64px" stroke-width="0.9" height="64px" viewBox="0 0 24 24"
                                               fill="none" xmlns="http://www.w3.org/2000/svg" color="#ffffff">
