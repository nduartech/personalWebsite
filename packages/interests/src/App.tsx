...
const App: Component = (props: any) => {
    ...
    return (
        <div
            ...
            <div class="h-screen w-screen flex flex-col justify-start items-center pt-20 md:pt-32">
                <div
