    ...
    <div
        ...
        <div class="flex flex-col justify-start md~mt-20 sm~portrait_h-screen sm~landscape_h-fit md~landscape_h-screen w-full items-center">
            ...
            <div class="w-10/12 flex flex-row justify-center items-center py-5 bg-[rgba(_35,_188,_255,_0.1)] backdrop-filter backdrop-blur rounded-[10px] dark~bg-[rgba(_1,_45,_80,_0.8)] mb-5">
                ...
                w-full py-2 px-2 text-sm font-medium text-regal-blue-700 hover~text-regal-blue-50 dark~text-regal-blue-50 border-[none] rounded-[45px] shadow-[0px_8px_15px_rgba(0,0,0,0.2)] transition-all cursor-pointer outline-[none] hover~shadow-[0px_4px_7px_rgba(202,_138,_4,_0.4)] dark~hover~shadow-[0px_4px_7px_rgba(88,28,135,0.4)] hover~-translate-y-[-4px]">
