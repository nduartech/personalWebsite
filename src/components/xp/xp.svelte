<script lang="ts">
    ...
    let techs = ['css', 'js', 'ts', 'java', 'python', 'golang', 'sql', 'single-spa', 'angular', 'spring-boot', 'spring-integration', 'spring-cloud', 'spring-security', 'kafka', 'mongo', 'hazelcast', 'yavi'];
...
<div class="flex flex-col w-full h-full justify-center items-center">
            ...
            <Carousel.Root setApi={(emblaApi) => (api = emblaApi)}>
                <Carousel.Content>
                    {#each contents as content}
                        <Carousel.Item>
                            <Card.Root class="w-full h-96 mx-auto overflow-y-scroll">
                                <Card.Header>
    ...
    <div class="w-full h-2/6 bg-black dark:bg-white">
